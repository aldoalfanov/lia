  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:14vw; height:7vh; padding-top:0px;" alt="Brand" src="asset/img/br1.png">
      </a>
    </div>
      ...
      <li>
        <?php 
          ...
          if(isset($_SESSION['idPelangan'])){
            $idPelangan = $_SESSION['idPelangan'];
            $queryUser = mysqli_query($conn, "SELECT * FROM tabel_pelangan WHERE idPelangan='$_SESSION[idPelangan]'");
    ...
    <form action="pencarian.php" method="get" class="navbar-form navbar-right" style="margin-top: 4vh">
      <div class="input-group" style="width:45vw; margin-right: 8vw; margin-top: 1vh;">
        <input type="text" class="form-control" placeholder="Pencaharian gitar " name="keyword">
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:14vw; height:7vh; padding-top:2vh;" alt="Brand" src="asset/img/br1.png"></a>
    </div>
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2">
        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Kategori Produk Gitar<span class="caret" style="margin-left:10px"></span></a>
            <ul class="dropdown-menu">
              <li><a data-toggle="pill" href="#akustik">Acoustik</a></li>
              <li><a data-toggle="pill" href="#listrik">Listrik</a></li>
            </ul>

        </li>
        <li><a data-toggle="pill" href="#akustik">Gitar Akustik</a></li>
		<li><a data-toggle="pill" href="#listrik">Gitar Listrik</a></li>
