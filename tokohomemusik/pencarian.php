  ...
  <div class="container">
    ...
    if(isset($keyword)){
      ...
      ';
        ...
        $queryCari = "SELECT * FROM tabel_gitar WHERE nama LIKE '%$keyword%'";
      ...
      if($jumlahCari > 0){
        while($arrayCari = mysqli_fetch_array($query_cari)){
          echo '
            <li>
        <a href="#'.$arrayCari['idGitar'].'">
          <img src="admin/proses/'.$arrayCari['path'].'" alt="'.$arrayCari['nama'].'">
          <span></span>
        </a>
        <div class="overlay" id="'.$arrayCari['idGitar'].'">
          ...
          <div class="keterangan">
            <div class="container">
              ...
              if(isset($_SESSION['idUser'])){
                echo '
                  <a href="proses/beli.php?idGitar='.$arrayCari['idGitar'].'&idUser='.$iduser.'"><button type="button" class="btn btn-info">Masukkan Keranjang</button></a>
                ';
              }else{
                echo '
